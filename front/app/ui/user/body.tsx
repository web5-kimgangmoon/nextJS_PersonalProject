...
import { myBoardListData, mycmtData } from "@/app/lib/placeholder-data";
...
export function MyBoard() {
  return (
    <div className="py-2">
      <div className="flex border border-bgGray rounded-2xl w-full min-h-20">
            ...
            <div className="flex">
              <div>
                <ImgButton
                  ...
                  isLessGap={true}
                  className="text-textBlue text-sm"
                >
                  300
                </ImgButton>
              </div>
              <div>
                <ImgButton
                  ...
                  size="smallest"
                  icon={
                    <Star className="text-borderGray w-[22px]" isFill={true} />
                  }
                  isLessGap={true}
                  className="text-textBlue text-sm"
                >
